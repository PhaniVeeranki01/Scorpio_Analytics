...
export const metadata: Metadata = {
  ...
  icons: { icon: [{ url: "/favicon.png", sizes: "512x512", type: "image/png" }, { url: "/favicon.ico", type: "image/x-icon" }], shortcut: "/favicon.ico", apple: [{ url: "/apple-touch-icon.png", sizes: "180x180", type: "image/png" }] }, manifest: "/site.webmanifest",
...
const structuredData = { "@context": "https://schema.org", "@graph": [{ "@type": "WebSite", "@id": "https://scorpioanalytics.com/#website", url: "https://scorpioanalytics.com/", name: "Scorpio Analytics", alternateName: ["ScorpioAnalytics", "scorpioanalytics.com"], publisher: { "@id": "https://scorpioanalytics.com/#organization" } }, { "@type": "Organization", "@id": "https://scorpioanalytics.com/#organization", name: "Scorpio Analytics", url: "https://scorpioanalytics.com/", logo: { "@type": "ImageObject", url: "https://scorpioanalytics.com/favicon.png", width: 512, height: 512 }, email: "support@scorpioanalytics.com", sameAs: ["https://www.linkedin.com/company/142884752/"] }] };
